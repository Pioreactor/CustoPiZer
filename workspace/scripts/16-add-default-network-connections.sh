...
cp /files/system/NetworkManager/PioreactorDefaultEth.nmconnection.nmconnection /etc/NetworkManager/system-connections/
...
sudo chmod 600 /etc/NetworkManager/system-connections/PioreactorDefaultEth.nmconnection.nmconnection
